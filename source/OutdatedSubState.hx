...
class OutdatedSubState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var txt:FlxText = new FlxText(0, 0, FlxG.width,
			...
			+ "\nThe character used in this mod was made by the VS Bob Team"
			+ "\nGo check them out!"
			+ "\n\nPress Space or Enter to go the VS Bob mod\nor ESCAPE to play VS Ron",
			32);
	...
	override function update(elapsed:Float)
	{
		if (controls.ACCEPT)
		{
			fancyOpenURL("https://gamebanana.com/mods/285296");
		}
		if (controls.BACK)
		{
			leftState = true;
